	...
	'Cleanup and maintenance tags': {
		...
		'Fiction-related cleanup': [
			...
			{ tag: 'Fiction', description: 'fails to distinguish between fact and fiction' },
			{
				tag: 'In-universe',
				description:
					'subject is fictional and needs rewriting to provide a non-fictional perspective',
			},
	...
	'General content issues': {
		'Importance and notability': [
			{
				...
				subgroup: {
					...
					list: [
						{
							label:
								"{{notability}}: article's subject may not meet the general notability guideline",
							value: '',
						},
						{
						...
						{
							label:
								'{{notability|Companies}}: notability guidelines for companies and organizations',
							value: 'Companies',
						},
			...
			{ tag: 'Context', description: 'insufficient context for those unfamiliar with the subject' },
			{
				...
				subgroup: [
					...
					},
					{
						...
						label: 'Reason: ',
						tooltip:
							'Short explanation describing the issue. Either Reason or Talk link is required.',
					},
					{
		...
		'Neutrality, bias, and factual accuracy': [
			...
			},
			{
				tag: 'Over-coverage',
				description:
					'extensive bias or disproportional coverage towards one or more specific regions',
			},
			{
			...
			},
			{
				tag: 'Peacock',
				description:
					'contains wording that promotes the subject in a subjective manner without adding information',
			},
		...
		'Verifiability and sources': [
			...
			{ tag: 'Original research', description: 'contains original research' },
			{
				tag: 'Primary sources',
				description:
					'relies too much on references to primary sources, and needs secondary sources',
			},
			{
				tag: 'Self-published',
