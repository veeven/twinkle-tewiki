...
export class Protect extends ProtectCore {
	...
	getProtectionPresets(): quickFormElementData[] {
		return [
			{ label: 'Unprotection', value: 'unprotect' },
			{
				...
				list: [
					{ label: 'Generic (full)', value: 'pp-protected' },
					{
						...
						value: 'pp-dispute',
						reason: 'Content dispute/edit warring',
					},
					{
			...
			},
			{
				...
				list: [
					{
						label: 'Highly visible template (TE)',
						value: 'pp-template',
						reason: '[[WP:HIGHRISK|High-risk template]]',
					},
				],
			},
			{
				...
				list: [
					...
					},
					{
						...
						value: 'pp-30-500-blp',
						reason: '[[WP:BLP|BLP]] policy violations',
					},
					{
						label: 'Sockpuppetry (ECP)',
						value: 'pp-30-500-sock',
						reason: 'Persistent [[WP:SOCK|sockpuppetry]]',
					},
				],
			},
			{
			...
			},
			{
				...
				list: [
					{ label: 'Generic (move)', value: 'pp-move' },
					{
						...
						reason: 'Page title dispute/move warring',
					},
					{
						label: 'Page-move vandalism (move)',
						value: 'pp-move-vandalism',
						reason: 'Page-move vandalism',
					},
					{
						label: 'Highly visible page (move)',
						value: 'pp-move-indef',
						reason: 'Highly visible page',
					},
				],
			},
		].filter((type) => {
		...
		return [
			{ label: 'Unprotection', value: 'unprotect' },
			{
				...
				list: [
					...
					{
						label: 'Recently deleted BLP',
						value: 'pp-create-blp',
						reason: 'Recently deleted [[WP:BLP|BLP]]',
					},
				],
			},
		];
	...
	protectionPresetsInfo = {
		...
		'pp-30-500-disruptive': {
			...
			move: 'extendedconfirmed',
			reason:
				'Persistent [[WP:Disruptive editing|disruptive editing]] from (auto)confirmed accounts',
			template: 'pp-30-500',
		},
		'pp-30-500-blp': {
			edit: 'extendedconfirmed',
