		...
		const messages: MessagesType = {
				...
				'Behavior in articles': {
					'uw-biog': {
						...
						level2: {
							label: 'Adding unreferenced controversial information about living persons',
							summary:
								'Caution: Adding unreferenced controversial information about living persons',
						},
						level3: {
							label:
								'Adding unreferenced controversial/defamatory information about living persons',
							summary:
								'Warning: Adding unreferenced controversial information about living persons',
						},
						level4: {
					...
					'uw-genre': {
						level1: {
							...
							summary:
								'General note: Frequent or mass changes to genres without consensus or references',
						},
						level2: {
							label: 'Frequent or mass changes to genres without consensus or references',
							summary:
								'Caution: Frequent or mass changes to genres without consensus or references',
						},
						level3: {
						...
						level4: {
							label: 'Frequent or mass changes to genres without consensus or reference',
							summary:
								'Final warning: Frequent or mass changes to genres without consensus or reference',
						},
					},
					'uw-image': {
						level1: {
					...
					'uw-nor': {
						...
						level2: {
							label: 'Adding original research, including unpublished syntheses of sources',
							summary:
								'Caution: Adding original research, including unpublished syntheses of sources',
						},
						level3: {
							label: 'Adding original research, including unpublished syntheses of sources',
							summary:
								'Warning: Adding original research, including unpublished syntheses of sources',
						},
						level4: {
							label: 'Adding original research, including unpublished syntheses of sources',
							summary:
								'Final warning: Adding original research, including unpublished syntheses of sources',
						},
					},
					'uw-notcensored': {
						level1: {
				...
				'Promotions and spam': {
					...
					'uw-paid': {
						level1: {
							...
							summary:
								'General note: Paid editing without disclosure under the Wikimedia Terms of Use',
						},
						level2: {
							label: 'Paid editing without disclosure under the Wikimedia Terms of Use',
						...
						level4: {
							label: 'Paid editing without disclosure under the Wikimedia Terms of Use',
							summary:
								'Final warning: Paid editing without disclosure under the Wikimedia Terms of Use',
						},
					},
					'uw-spam': {
						level1: {
			...
			singlenotice: {
				...
				'uw-elinbody': {
					...
					summary:
						'Notice: Keep external links to External links sections at the bottom of an article',
				},
				'uw-english': {
				...
				'uw-hasty': {
					...
					summary:
						'Notice: Allow creators time to improve their articles before tagging them for deletion',
				},
				'uw-italicize': {
					label: 'Italicize books, films, albums, magazines, TV series, etc within articles',
					summary:
						'Notice: Italicize books, films, albums, magazines, TV series, etc within articles',
				},
				'uw-lang': {
